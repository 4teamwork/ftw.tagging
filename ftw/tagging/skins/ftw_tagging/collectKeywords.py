...
# special handling for ftw.tagging
# only return tags from the vocabulary, but we can't set enforceVocabulary
# because it must be possible to add new ones

if vocab_source == 'special_tag_source':
    result = allowed
else:
